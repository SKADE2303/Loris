      ...
      <div className="filter-grid">
        ...
        {Object.keys(props.data['options']['projects']).length > 0 && (
          <div>
            ...
            <SelectElement
              ...
              options={{__clear__: clearSelection, ...optionsProjects}}
              multiple={true}
              emptyOption={false}
        ...
        {Object.keys(props.data['options']['cohorts']).length > 0 && (
          <div>
            ...
            <SelectElement
              ...
              options={{__clear__: clearSelection, ...optionsCohorts}}
              multiple={true}
              emptyOption={false}
        ...
        {Object.keys(props.data['options']['visits']).length > 0 && (
          <div>
            ...
            <SelectElement
              name='selectedVisits'
              options={{__clear__: clearSelection, ...optionsVisits}}
              multiple={true}
              emptyOption={false}
        ...
        {Object.keys(props.data['options']['participantStatus']).length > 0 && (
          <div>
            <label style={{fontWeight: 'bold',
              marginBottom: '5px',
              display: 'block'}}>{t('Participant Status', {ns: 'loris'})}</label>
            <SelectElement
              name='selectedParticipantStatus'
              options={{__clear__: clearSelection, ...optionsStatus}}
              multiple={true}
              emptyOption={false}
